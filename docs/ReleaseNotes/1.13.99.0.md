---
permalink: /1.13.99.0.html
title: Release Notes v1.13.99.0
...
* 67 total parts (65+2)
  * Initial update pass done on 16 parts
    * 1.25m, 2.50m short, 2.50m long Cargo Bays
    * Probe
      * 1.25m Cone
      * Radial 1
      * Radial 2 (advanced)
...
<!-- shields -->
[SHD:mod]: https://img.shields.io/badge/Modular%20Rocket%20Systems%20(MRS)%20-v1.13.99.0--adoption-BADA55.svg?style=plastic&labelColor=darkgreen/ "1.13.99.0-adoption"
