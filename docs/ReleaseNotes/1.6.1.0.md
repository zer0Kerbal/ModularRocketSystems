---
permalink: /1.6.1.0.html
title: Release Notes v1.6.1.0
...
[![Modular Rocket Systems (MRS)][SHD:mod]][forum]  
[![KSP version][SHD:ksp]][KSP:url] [![License][LIC:shd]][LIC:url]  
![AVC .version files][AVCVAL:shd] [![Pages][SHD:pages]][pages]

## Version 1.6.1.0-release - `<Archival>` edition

* Released
  * 29 Apr 2015
  * for Kerbal Space Program 1.0.0
  * by [zer0Kerbal](https://github.com/zer0Kerbal)

<div style="border:0.5px solid Tomato; background-color: #bada55; color: #FF0000; text-align:center"><h4>
<b>For best results - DO A CLEAN INSTALL; DELETE EXISTING INSTALLATION THEN RE-INSTALL</b></h4><p>Download from <a href="https://www.curseforge.com/kerbal/ksp-mods/ModularRocketSystems/files">CurseForge</a></p></div>

 by [NecroBones](https://github.com/NecroBones)
...
* Remember to like, subscribe, star and post comments!
...
<!-- shields -->
[SHD:mod]: https://img.shields.io/badge/Modular%20Rocket%20Systems%20(MRS)%20-v1.6.1.0--release-BADA55.svg?style=plastic&labelColor=darkgreen/ "1.6.1.0-release"
...
[AVCVAL:shd]: https://github.com/zer0Kerbal/ModularRocketSystems/actions/workflows/AVC-VersionFileValidator.yml/badge.svg?style=plastic&labelColor=black "AVC Valid"
